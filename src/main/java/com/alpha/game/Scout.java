...
public class Scout extends Thread
{
	...
	Scout(int x, int y, Game g, GameState st, int t)
	{
		...
		//TODO Remember to add this case back in	
...
//	}
	...
	//TODO remove this annotation and use a non-deprecated method
	// They are deprecated for a reason and my not be supported in the future
	// Your code could break, or the method may be unsafe
